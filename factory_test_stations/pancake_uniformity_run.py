...
def main():
    ...
    print(f"Station: pancake_uniformity")
    ...
    if force_console:
        ...
        try:
            ...
            runner = console_test_runner.ConsoleTestRunner('pancake_uniformity')
...
def print_usage():
    ...
    print("""
Factory Test Station Runner - Pancake Uniformity

Usage:
    python pancake_uniformity_run.py [options]
...
Examples:
    python pancake_uniformity_run.py              # Console mode (default)
    python pancake_uniformity_run.py --console    # Force console mode
    python pancake_uniformity_run.py --tk         # Force tkinter kiosk mode
    python pancake_uniformity_run.py --web        # Force web browser GUI
""")
