...
class seacliffmotFixture(hardware_station_common.test_station.test_fixture.TestFixture):
    ...
    def close(self):
        self._operator_interface.print_to_console("Closing Fixture\n")
    ...
    def elminator_on(self):
        ...
        if "0" in response[1]:
            ...
            raise seacliffmotFixtureError("Fail to Read %s" % response[0])
        return value
...
if __name__ == "__main__":
        ...
        the_fixture = seacliffmotFixture(station_config, station_config)
