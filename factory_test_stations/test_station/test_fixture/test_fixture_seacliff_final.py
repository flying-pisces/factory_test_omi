...
class seaclifffinalFixture(hardware_station_common.test_station.test_fixture.TestFixture):
    """
    ...
    def initialize(self):
        self._operator_interface.print_to_console("Initializing seacliff final Fixture\n")

    def close(self):
        self._operator_interface.print_to_console("Closing seacliff final Fixture\n")
