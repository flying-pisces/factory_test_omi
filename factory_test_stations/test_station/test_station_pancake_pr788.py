...
import test_station.test_fixture.test_fixture_pancake_pr788 as test_fixture_pancake_pr788
import test_station.dut as dut
import time


class pancakePr788Error(Exception):
    pass


class pancakepr788Station(test_station.TestStation):

    def __init__(self, station_config, operator_interface):
        test_station.TestStation.__init__(self, station_config, operator_interface)
        self._fixture = test_fixture_pancake_pr788.pancakepr788Fixture(station_config, operator_interface)
        self._overall_errorcode = ''
        self._first_failed_test_resulta = None

    def initialize(self):
        try:
            self._operator_interface.print_to_console("Initializing pancake pr788 station...\n")
