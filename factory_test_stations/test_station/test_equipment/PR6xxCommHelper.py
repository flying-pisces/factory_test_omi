...
class PR6xxEquipmentError(Exception):
    pass
...
# =================================Pr788 Classe===========================
class PR6xxEquipment(object):
    """
        class for Eureka PR6XX Equipment
    ...
    def __init__(self, station_config, operator_interface):
        ...
        fullpath = os.path.abspath(sys.modules[PR6xxEquipment.__module__].__file__)
    ...
    def initialize(self):
        self._operator_interface.print_to_console("Initializing Eureka PR6XX Equipment\n")

    def close(self):
        self._operator_interface.print_to_console("Closing Eureka PR6XX Equipment\n")
    ...
    def deviceSpectralMeasure(self, spectralData, measurementData: MeasurementData):
        ...
        :return: tuple
        '''
        return self._device.prDeviceSpectralMeasure(spectralData, measurementData)
...
if __name__ == '__main__':
    ...
    the_equip = PR6xxEquipment(station_config, station_config)
    the_equip.initialize()
    ver = the_equip.version_info()
    ss = the_equip.deviceGetDateTime()
