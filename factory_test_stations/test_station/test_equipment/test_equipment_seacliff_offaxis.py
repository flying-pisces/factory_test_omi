...
class SeacliffOffAxisEquipmentError(Exception):
    pass


class SeacliffOffAxisEquipment(hardware_station_common.test_station.test_equipment.TestEquipment):
...
if __name__ == "__main__":
    ...
    the_instrument = SeacliffOffAxisEquipment(station_config)
