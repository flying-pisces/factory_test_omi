...
class seaclifffinalError(Exception):
    pass


class seaclifffinalStation(test_station.TestStation):
    """
    ...
    def initialize(self):
        try:
            self._operator_interface.print_to_console("Initializing secliff final station...\n")
