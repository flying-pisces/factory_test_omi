...
class adb_device():
    def __init__(self, serial=None, remote=None, custom_adb_path="adb", timeout=90, verbose=False):
        self.serial = serial #serial of specific device we want to connect to if specified
        self.remote = remote #ip of remote device if not none
        ...
        #make sure the adb server is running before continuing
