...
import test_station.test_station_eureka_motpr as test_station_eureka_motpr
...
if __name__ == '__main__':
    ...
    FACTORY_TEST_GUI = gui.FactoryTestGui(station_config, test_station_eureka_motpr.EurekaMotPRStation)
    # enter the main loop
