...
def main():
    ...
    print(f"Station: seacliff_eeprom")
    ...
    if force_console:
        ...
        try:
            ...
            runner = console_test_runner.ConsoleTestRunner('seacliff_eeprom')
...
def print_usage():
    ...
    print("""
Factory Test Station Runner - Seacliff EEPROM

Usage:
    python seacliff_eeprom_run.py [options]
...
Examples:
    python seacliff_eeprom_run.py              # Console mode (default)
    python seacliff_eeprom_run.py --console    # Force console mode
    python seacliff_eeprom_run.py --tk         # Force tkinter kiosk mode
    python seacliff_eeprom_run.py --web        # Force web browser GUI
""")
