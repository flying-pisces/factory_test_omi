...
import test_station.test_station_seacliff_offaxis4 as test_station_seacliff_offaxis4
...
if __name__ == '__main__':
    ...
    FACTORY_TEST_GUI = gui.FactoryTestGui(station_config, test_station_seacliff_offaxis4.SeacliffOffAxis4Station)
    # enter the main loop
