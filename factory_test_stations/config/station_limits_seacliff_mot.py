...
STATION_LIMITS_ARRAYS = [
    ...
    ["normal_W255_SaturationLevel_X", 0.25, 1.2, 20005],
    ["normal_W255_SaturationLevel_Xz", 0.25, 1.2, 20006],
    ["normal_W255_SaturationLevel_Ya", 0.25, 1.2, 20007],
    ["normal_W255_SaturationLevel_Yb", 0.25, 1.2, 20008],
    ["normal_W255_SaturationLevel_Z", 0.25, 1.2, 20009],
    ["normal_W255_Module Temperature", None, None, 20010],
    ["normal_W255_OnAxis Lum", 80, None, 20011],
    ["normal_W255_OnAxis x", 0.2971, 0.3521, 20012],
    ["normal_W255_OnAxis y", 0.3112, 0.3662, 20013],
    ...
    ["normal_W255_u'v'_delta_to_OnAxis_30deg", 0, 0.02, 20054],
    ...
    # ["normal_R255_SaturationLevel_X", 0.25, 1.2, 21005],
    # ["normal_R255_SaturationLevel_Xz", 0.25, 1.2, 21006],
    # ["normal_R255_SaturationLevel_Ya", 0.25, 1.2, 21007],
    # ["normal_R255_SaturationLevel_Yb", 0.25, 1.2, 21008],
    # ["normal_R255_SaturationLevel_Z", 0.25, 1.2, 21009],
    ...
    # ["normal_G255_SaturationLevel_X", 0.25, 1.2, 22005],
    # ["normal_G255_SaturationLevel_Xz", 0.25, 1.2, 22006],
    # ["normal_G255_SaturationLevel_Ya", 0.25, 1.2, 22007],
    # ["normal_G255_SaturationLevel_Yb", 0.25, 1.2, 22008],
    # ["normal_G255_SaturationLevel_Z", 0.25, 1.2, 22009],
    ...
    # ["normal_B255_SaturationLevel_X", 0.25, 1.2, 23005],
    # ["normal_B255_SaturationLevel_Xz", 0.25, 1.2, 23006],
    # ["normal_B255_SaturationLevel_Ya", 0.25, 1.2, 23007],
    # ["normal_B255_SaturationLevel_Yb", 0.25, 1.2, 23008],
    # ["normal_B255_SaturationLevel_Z", 0.25, 1.2, 23009],
    ...
    ["normal_RGBBoresight_DispCen_x_display", -10, 12.5, 24031],
    ["normal_RGBBoresight_DispCen_y_display", -15, 10, 24032],
    ["normal_RGBBoresight_Disp_Rotate_x", -1, 0.75, 24033],

    ["normal_RGBBoresight_R_Lum_corrected", None, None, 24034],
    ["normal_RGBBoresight_R_x_corrected", None, None, 24035],
    ["normal_RGBBoresight_R_y_corrected", None, None, 24036],
    ["normal_RGBBoresight_G_Lum_corrected", None, None, 24037],
    ["normal_RGBBoresight_G_x_corrected", None, None, 24038],
    ["normal_RGBBoresight_G_y_corrected", None, None, 24039],
    ["normal_RGBBoresight_B_Lum_corrected", None, None, 24040],
    ["normal_RGBBoresight_B_x_corrected", None, None, 24041],
    ["normal_RGBBoresight_B_y_corrected", None, None, 24042],
    ...
    # ["normal_GreenDistortion_SaturationLevel_X", 0.25, 1.2, 25005],
    # ["normal_GreenDistortion_SaturationLevel_Xz", 0.25, 1.2, 25006],
    # ["normal_GreenDistortion_SaturationLevel_Ya", 0.25, 1.2, 25007],
    # ["normal_GreenDistortion_SaturationLevel_Yb", 0.25, 1.2, 25008],
    # ["normal_GreenDistortion_SaturationLevel_Z", 0.25, 1.2, 25009],
    ...
    ["normal_WhiteDot_WP R Seacliff Algo", 215, 255, 26023],
    ["normal_WhiteDot_WP G Seacliff Algo", 215, 255, 26024],
    ["normal_WhiteDot_WP B Seacliff Algo", 215, 255, 26025],
    ...
    # ["normal_PW255_SaturationLevel_X", 0.25, 1.2, 27005],
    # ["normal_PW255_SaturationLevel_Xz", 0.25, 1.2, 27006],
    # ["normal_PW255_SaturationLevel_Ya", 0.25, 1.2, 27007],
    # ["normal_PW255_SaturationLevel_Yb", 0.25, 1.2, 27008],
    # ["normal_PW255_SaturationLevel_Z", 0.25, 1.2, 27009],
