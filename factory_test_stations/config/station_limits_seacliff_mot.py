...
STATION_LIMITS_ARRAYS = [
    ...
    ["normal_RGBBoresight_R_Lum_corrected", 16, 36, 24034],
    ["normal_RGBBoresight_R_x_corrected", 0.6424, 0.6924, 24035],
    ["normal_RGBBoresight_R_y_corrected", 0.291, 0.341, 24036],
    ["normal_RGBBoresight_G_Lum_corrected", 57, 112, 24037],
    ["normal_RGBBoresight_G_x_corrected", 0.2404, 0.2904, 24038],
    ["normal_RGBBoresight_G_y_corrected", 0.6286, 0.6786, 24039],
    ["normal_RGBBoresight_B_Lum_corrected", 4, 8, 24040],
    ["normal_RGBBoresight_B_x_corrected", 0.1302, 0.1802, 24041],
    ["normal_RGBBoresight_B_y_corrected", 0.0221, 0.0721, 24042],
    ...
    ["normal_WhiteDot_WP R to DDIC", 215, 255, 26029],
    ["normal_WhiteDot_WP G to DDIC", 210, 255, 26030],
    ["normal_WhiteDot_WP B to DDIC", 200, 255, 26031],
