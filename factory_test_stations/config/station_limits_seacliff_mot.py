...
STATION_LIMITS_ARRAYS = [
    ...
    ["Test_RAW_IMAGE_SAVE_SUCCESS_normal_WhiteDot", True, True, 10019],
    # ["Test_RAW_IMAGE_SAVE_SUCCESS_normal_WhiteDotV2", True, True, 10020],
    ["Test_RAW_IMAGE_SAVE_SUCCESS_normal_RGBBoresight", True, True, 10020],

    ["UUT_TEMPERATURE_normal_W255", None, None, 11001],
    # ["UUT_TEMPERATURE_normal_G127", None, None, 11002],
    # ["UUT_TEMPERATURE_normal_W000", None, None, 11003],
    # ["UUT_TEMPERATURE_normal_RGB", None, None, 11004],
    ["UUT_TEMPERATURE_normal_R255", None, None, 11005],
    ["UUT_TEMPERATURE_normal_G255", None, None, 11006],
    ["UUT_TEMPERATURE_normal_B255", None, None, 11007],
    # ["UUT_TEMPERATURE_normal_GreenContrast", None, None, 11008],
    # ["UUT_TEMPERATURE_normal_WhiteContrast", None, None, 11009],
    # ["UUT_TEMPERATURE_normal_GreenSharpness", None, None, 11010],
    ["UUT_TEMPERATURE_normal_GreenDistortion", None, None, 11011],

    # ["UUT_TEMPERATURE_extendedz_GreenDistortion", None, None, 11012],
    # ["UUT_TEMPERATURE_extendedz_W255", None, None, 11013],
    # ["UUT_TEMPERATURE_blemish_W255", None, None, 11014],
    # ["UUT_TEMPERATURE_extendedxpos_W255", None, None, 11015],
    # ["UUT_TEMPERATURE_extendedxneg_W255", None, None, 11016],
    # ["UUT_TEMPERATURE_extendedypos_W255", None, None, 11017],
    # ["UUT_TEMPERATURE_extendedyneg_W255", None, None, 11018],
    ["UUT_TEMPERATURE_normal_WhiteDot", None, None, 11019],
    # ["UUT_TEMPERATURE_normal_WhiteDotV2", None, None, 11020],
    ["UUT_TEMPERATURE_normal_RGBBoresight", None, None, 11021],
    ...
    ["normal_GreenDistortion_Y_DispCen_x_cono", None, None, 25010],
    ["normal_GreenDistortion_Y_DispCen_y_cono", None, None, 25011],
    ["normal_GreenDistortion_Y_DispCen_x_display", None, None, 25012],
    ["normal_GreenDistortion_Y_DispCen_y_display", None, None, 25013],
    ["normal_GreenDistortion_Y_Disp_Rotate_x", None, None, 25014],
    ["normal_GreenDistortion_Y_Disp_Rotate_y", None, None, 25015],
...
if __name__ == '__main__':
    ...
    GREENDISTORTION_Items_V3= "DispCen_x_cono,DispCen_y_cono,DispCen_x_display,DispCen_y_display,Disp_Rotate_x,Disp_Rotate_y"
