...
STATION_LIMITS_ARRAYS = [
    ...
    ["normal_WhiteDot_WP R Arcata Algorithm", 215, 255, 26023],
    ["normal_WhiteDot_WP G Arcata Algorithm", 215, 255, 26024],
    ["normal_WhiteDot_WP B Arcata Algorithm", 215, 255, 26025],
