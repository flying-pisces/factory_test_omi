...
STATION_LIMITS_ARRAYS = [
    ...
    ["normal_W255_SaturationLevel_X", 0.4, 1.1, 20005],
    ["normal_W255_SaturationLevel_Xz", 0.4, 1.1, 20006],
    ["normal_W255_SaturationLevel_Ya", 0.4, 1.1, 20007],
    ["normal_W255_SaturationLevel_Yb", 0.4, 1.1, 20008],
    ["normal_W255_SaturationLevel_Z", 0.5, 1.1, 20009],
    ["normal_W255_Module Temperature", None, None, 20010],
    ["normal_W255_OnAxis Lum", None, None, 20011],
    ["normal_W255_OnAxis x", None, None, 20012],
    ["normal_W255_OnAxis y", None, None, 20013],
    ...
    ["normal_R255_SaturationLevel_X", 0.4, 1.1, 21005],
    ["normal_R255_SaturationLevel_Xz", 0.4, 1.1, 21006],
    ["normal_R255_SaturationLevel_Ya", 0.4, 1.1, 21007],
    ["normal_R255_SaturationLevel_Yb", 0.4, 1.1, 21008],
    ["normal_R255_SaturationLevel_Z", 0.4, 1.1, 21009],
    ["normal_R255_Module Temperature", None, None, 21010],
    ["normal_R255_OnAxis Lum", None, None, 21011],
    ["normal_R255_OnAxis x", None, None, 21012],
    ["normal_R255_OnAxis y", None, None, 21013],
    ...
    ["normal_G255_SaturationLevel_X", 0.4, 1.1, 22005],
    ["normal_G255_SaturationLevel_Xz", 0.4, 1.1, 22006],
    ["normal_G255_SaturationLevel_Ya", 0.4, 1.1, 22007],
    ["normal_G255_SaturationLevel_Yb", 0.4, 1.1, 22008],
    ["normal_G255_SaturationLevel_Z", 0.4, 1.1, 22009],
    ["normal_G255_Module Temperature", None, None, 22010],
    ["normal_G255_OnAxis Lum", None, None, 22011],
    ["normal_G255_OnAxis x", None, None, 22012],
    ["normal_G255_OnAxis y", None, None, 22013],
    ...
    ["normal_B255_SaturationLevel_X", 0.4, 1.1, 23005],
    ["normal_B255_SaturationLevel_Xz", 0.4, 1.1, 23006],
    ["normal_B255_SaturationLevel_Ya", 0.4, 1.1, 23007],
    ["normal_B255_SaturationLevel_Yb", 0.4, 1.1, 23008],
    ["normal_B255_SaturationLevel_Z", 0.4, 1.1, 23009],
    ["normal_B255_Module Temperature", None, None, 23010],
    ["normal_B255_OnAxis Lum", None, None, 23011],
    ["normal_B255_OnAxis x", None, None, 23012],
    ["normal_B255_OnAxis y", None, None, 23013],
    ...
    ["normal_RGBBoresight_SaturationLevel_X", 0.4, 1.1, 24005],
    ["normal_RGBBoresight_SaturationLevel_Xz", 0.4, 1.1, 24006],
    ["normal_RGBBoresight_SaturationLevel_Ya", 0.4, 1.1, 24007],
    ["normal_RGBBoresight_SaturationLevel_Yb", 0.4, 1.1, 24008],
    ["normal_RGBBoresight_SaturationLevel_Z", 0.4, 1.1, 24009],
    ...
    ["normal_RGBBoresight_DispCen_x_display", None, None, 24031],
    ["normal_RGBBoresight_DispCen_y_display", None, None, 24032],
    ["normal_RGBBoresight_Disp_Rotate_x", None, None, 24033],
    ...
    # ["normal_GreenDistortion_SaturationLevel_X", 0.4, 1.1, 25005],
    # ["normal_GreenDistortion_SaturationLevel_Xz", 0.4, 1.1, 25006],
    # ["normal_GreenDistortion_SaturationLevel_Ya", 0.4, 1.1, 25007],
    # ["normal_GreenDistortion_SaturationLevel_Yb", 0.4, 1.1, 25008],
    # ["normal_GreenDistortion_SaturationLevel_Z", 0.4, 1.1, 25009],
    ...
    ["normal_WhiteDot_SaturationLevel_X", 0.4, 1.1, 26006],
    ["normal_WhiteDot_SaturationLevel_Xz", 0.4, 1.1, 26007],
    ["normal_WhiteDot_SaturationLevel_Ya", 0.4, 1.1, 26008],
    ["normal_WhiteDot_SaturationLevel_Yb", 0.4, 1.1, 26009],
    ["normal_WhiteDot_SaturationLevel_Z", 0.4, 1.1, 26010],
