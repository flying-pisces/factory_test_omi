...
CSV_SUMMARY_DIR = r'C:\oculus\factory_test_omi\factory_test_stations\factory-test_logs\project_summary'
RAW_DIR = r'C:\oculus\factory_test_omi\raw_logs'
##################################
# serial number codes
#
SERIAL_NUMBER_VALIDATION = False  # set to False for debugging
SERIAL_NUMBER_MODEL_NUMBER = '\dNBS[\d|\w]{10}$'  # Fake model number requirement, need config
