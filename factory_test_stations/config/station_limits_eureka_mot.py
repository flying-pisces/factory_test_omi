...
STATION_LIMITS_ARRAYS = [
    ...
    ["normal_W255_OnAxis Lum", 85, 135, 20011],
    ["normal_W255_OnAxis x", 0.29, 0.35, 20012],
    ["normal_W255_OnAxis y", 0.293, 0.383, 20013],
    ...
    ["normal_W255_Sky BRO(30deg)", 0.7, 1.3, 20020],
    ...
    ["normal_W255_Ground BRO(30deg)", 0.7, 1.3, 20024],
    ...
    ["normal_W255_Nasal BRO(30deg)", 0.7, 1.3, 20028],
    ...
    ["normal_W255_Temporal BRO(30deg)", 0.7, 1.3, 20032],
    ...
    ["normal_R255_OnAxis x", 0.622, 0.667, 21012],
    ["normal_R255_OnAxis y", 0.316, 0.366, 21013],
    ...
    ["normal_G255_OnAxis x", 0.274, 0.324, 22012],
    ["normal_G255_OnAxis y", 0.586, 0.636, 22013],
    ...
    ["normal_B255_OnAxis x", 0.128, 0.178, 23012],
    ["normal_B255_OnAxis y", 0.036, 0.086, 23013],
