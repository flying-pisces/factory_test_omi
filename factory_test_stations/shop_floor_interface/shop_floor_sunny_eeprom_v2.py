...
SF_URL = 'http://10.99.10.126:9092/WebService.asmx/'
SF_AAB_URL = 'http://10.99.10.126:9092/WSDetection.asmx/'
SF_MOT_DATA_URL = 'http://10.99.10.126:9092/WSGetDetectionData.asmx/'
        ...
        try:
            ...
            if set(exp_mes_items.keys()).issubset(dic.keys()):
                try:
                    ...
                    dic['lv_R255'] = float(dic['normal_R255_OnAxis Lum'])
                    dic['lv_G255'] = float(dic['normal_G255_OnAxis Lum'])
                    dic['lv_B255'] = float(dic['normal_B255_OnAxis Lum'])

                    dic['x_W255'] = float(dic["normal_W255_OnAxis x"])
                    dic['y_W255'] = float(dic["normal_W255_OnAxis y"])

                    dic['x_R255'] = float(dic["normal_R255_OnAxis x"])
                    dic['y_R255'] = float(dic["normal_R255_OnAxis y"])

                    dic['x_G255'] = float(dic["normal_G255_OnAxis x"])
                    dic['y_G255'] = float(dic["normal_G255_OnAxis y"])

                    dic['x_B255'] = float(dic["normal_B255_OnAxis x"])
                    dic['y_B255'] = float(dic["normal_B255_OnAxis y"])

                    dic['TemperatureW'] = float(dic['normal_W255_Module Temperature'])
                    dic['TemperatureR'] = float(dic['normal_R255_Module Temperature'])
                    dic['TemperatureG'] = float(dic['normal_G255_Module Temperature'])
                    dic['TemperatureB'] = float(dic['normal_B255_Module Temperature'])
                    dic['TemperatureWD'] = float(dic['normal_WhiteDot_Module Temperature'])
                    dic['WhitePointGLR'] = int(dic['normal_WhiteDot_WP R Arcata Algorithm'])
                    dic['WhitePointGLG'] = int(dic['normal_WhiteDot_WP G Arcata Algorithm'])
                    dic['WhitePointGLB'] = int(dic['normal_WhiteDot_WP B Arcata Algorithm'])
