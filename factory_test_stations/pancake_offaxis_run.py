...
def main():
    ...
    print(f"Station: pancake_offaxis")
    ...
    if force_console:
        ...
        try:
            ...
            runner = console_test_runner.ConsoleTestRunner('pancake_offaxis')
...
def print_usage():
    ...
    print("""
Factory Test Station Runner - Pancake Off-Axis

Usage:
    python pancake_offaxis_run.py [options]
...
Examples:
    python pancake_offaxis_run.py              # Console mode (default)
    python pancake_offaxis_run.py --console    # Force console mode
    python pancake_offaxis_run.py --tk         # Force tkinter kiosk mode
    python pancake_offaxis_run.py --web        # Force web browser GUI
""")
