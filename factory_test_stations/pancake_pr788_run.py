...
def main():
    ...
    if force_console:
        ...
        try:
            ...
            runner = console_test_runner.ConsoleTestRunner('pancake_pr788')
...
def print_usage():
    ...
    print("""
Factory Test Station Runner - Pancake PR788

Usage:
    python pancake_pr788_run.py [options]
...
Examples:
    python pancake_pr788_run.py              # Console mode (default)
    python pancake_pr788_run.py --console    # Force console mode
    python pancake_pr788_run.py --tk         # Force tkinter kiosk mode
    python pancake_pr788_run.py --web        # Force web browser GUI
""")
