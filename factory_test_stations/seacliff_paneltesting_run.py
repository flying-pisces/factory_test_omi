...
def main():
    ...
    print(f"Station: seacliff_paneltesting")
    ...
    if force_console:
        ...
        try:
            ...
            runner = console_test_runner.ConsoleTestRunner('seacliff_paneltesting')
...
def print_usage():
    ...
    print("""
Factory Test Station Runner - Seacliff Panel Testing

Usage:
    python seacliff_paneltesting_run.py [options]
...
Examples:
    python seacliff_paneltesting_run.py              # Console mode (default)
    python seacliff_paneltesting_run.py --console    # Force console mode
    python seacliff_paneltesting_run.py --tk         # Force tkinter kiosk mode
    python seacliff_paneltesting_run.py --web        # Force web browser GUI
""")
