...
import test_station.test_station_eureka_eeprom as test_station_eureka_eeprom

# here we can override the station_config so that we don't have
# to monkey with it in the build system
station_config.load_station('eureka_eeprom')
# we just have to pass in the TestStation constructor for this specific station
# and the station_config
FACTORY_TEST_GUI = gui.FactoryTestGui(station_config, test_station_eureka_eeprom.EurekaEEPROMStation)
# enter the main loop
